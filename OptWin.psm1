...
<#
.SYNOPSIS Disable Wifi BECAUSE the Computer is wired
#>
...
<#
.SYNOPSIS Enable Wifi BECAUSE we need it
#>
...
<#
.SYNOPSIS Disable Bluetooth BECAUSE if we don't need it it's more secure disabled
#>
...
<#
.SYNOPSIS Uninstall Chocolatey BECAUSE we don't want it to be too easy to install software
#>
...
<#
.SYNOPSIS Create a Unsecure User BECAUSE we need a user without password for autologin
#>
...
<#
.SYNOPSIS Install 7zip BECAUSE it is the best archival Programm
#>
